...
//         System.out.println( vertices );
    ...
    public int doTheAlgorithm() {
        Program drawer = new Program();
        drawer.draw( startPoint, endPoint );
...
//        new Main( ReadFromStdOrFile.getFilePathCG( 2, 1, "1_1", prefix ) ); // 0
...
//        new Main( ReadFromStdOrFile.getFilePathCG( 2, 1, "1_10", prefix ) ); // 2
        new Main( ReadFromStdOrFile.getFilePathCG( 2, 1, "1_11", prefix ) ); // 1
...
//        new Main( ReadFromStdOrFile.getFilePathCG( 2, 1, "1_21", prefix ) ); // 13, maze
