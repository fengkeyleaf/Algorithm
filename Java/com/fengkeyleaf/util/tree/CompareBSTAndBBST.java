...
final class CompareBSTAndBBST {
    final static BinarySearchTree<Integer, Integer> BST = new BinarySearchTree<>();
    final static RedBlackTree<Integer, Integer> RBTree = new RedBlackTree<>();
    static int dataScale;
...
//        dataScale = 1000;
    ...
    static void putBST( int i ) {
        BST.put( i, i );
    }

    static void deleteMaxBST() {
        while ( !BST.isEmpty() )
            BST.deleteMax();
    }

    static void deleteMinBST() {
        while ( !BST.isEmpty() )
            BST.deleteMin();
    }

    static void putBBST( int i ) {
        RBTree.put( i, i );
    }

    static void deleteMaxBBST() {
        while ( !RBTree.isEmpty() )
            RBTree.deleteMax();
    }

    static void deleteMinBBST() {
        while ( !RBTree.isEmpty() )
            RBTree.deleteMin();
    }

    static long measurePuttingRunningTime( Tree tree ) {
    ...
    static long measureDeleteMaxRunningTime( Tree tree ) {
        long startTime = System.currentTimeMillis();
    ...
    static long measureDeleteMinRunningTime( Tree tree ) {
        long startTime = System.currentTimeMillis();
    ...
    static long MeasureDeleteRandomly( Tree tree ) {
    ...
    static long measurePuttingRunningTimeRandomly( Tree tree ) {
        boolean[] ifDeleted = new boolean[ dataScale ];
        int count = dataScale;
        long totalTimeCost = 0;
    ...
    static long MeasureGetRandomly( Tree tree ) {
        boolean[] ifDeleted = new boolean[ dataScale ];
        int count = dataScale;
        long totalTimeCost = 0;
