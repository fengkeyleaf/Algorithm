...
//    private final String VERTEX_TYPE_FILEPATH = "src/myLibraries/GUI/geometry/triangulation/pics/vertex_type.png";
    ...
    void drawingWhich( Program.DrawingType drawingType ) {
        switch ( drawingType ) {
            ...
            case VERTEX_TYPE -> MonotoneVertex.drawVertexType( graphics, vertexTypePoints );
    ...
    public void drawVertexType( List<Vertex> vertices ) {
        this.vertexTypePoints = MonotoneVertex.drawVertexType( vertices, originWidth, originHeight, CANVAS_WIDTH, CANVAS_HEIGHT );
    }
