...
public class DoublyLinkedBST<K, V> extends BinarySearchTree<K, V>
    ...
    /**
     * get size of this doubly-linked R-B tree.
     * Note that this method is O(1),
     * using the size of the doubly-linked list.
     * */

    @Override
    public int size() {
        assert super.size() == linkedList.size();
    ...
    protected boolean check() {
        ...
        return isBST && isDoublyConnected && isLinked && isRightSize;
    }
}
