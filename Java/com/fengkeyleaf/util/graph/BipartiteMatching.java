...
public class BipartiteMatching extends InternetFlow {
    ...
    public InternetFlowVertex buildInternetFlow( int[] setLeftIDs, int[] setRightIDs,
        ...
        // add s and t
        InternetFlowVertex start = new InternetFlowVertex( vertices.length, InternetFlowVertex.Type.START );
        InternetFlowVertex end = new InternetFlowVertex( vertices.length + 1, InternetFlowVertex.Type.END );
        add( start );
        add( end );
