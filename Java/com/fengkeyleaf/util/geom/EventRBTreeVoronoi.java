...
public class EventRBTreeVoronoi extends DoublyLinkedRBT<EventSite, EventSite> {
    ...
    // Voronoi vertices.
    final List<VoronoiVertex> vertices = new ArrayList<>();

    /**
     * constructs to create an instance of EventRBTree
     * */

    EventRBTreeVoronoi( Comparator<EventSite> c ) {
        super( c );
    }
    ...
    private VorRBTNode delete( VorRBTNode root,
                               LinkedList<RBTreeNode<EventSite, EventSite>> path,
                               VorRBTNode  node ) {
