...
public final class GeometricIntersection {
    ...
    int collectLinesOnTheSameLine( Line line1, Line line2 ) {
        ...
        assert ( MyMath.equalZero( res1 ) && MyMath.equalZero( res2 ) ) == ( MyMath.equalZero( res3 ) && MyMath.equalZero( res4 ) );
        return MyMath.equalZero( res1 ) && MyMath.equalZero( res2 ) ? 0 : 1;
    }
...
//        line1.startPoint ).multiply( 1 / t );
    ...
    void findNewEvent( EventPoint2D lineLeft, EventPoint2D lineRight,
        ...
        // TODO: 6/16/2021 findIntersection() in IntersectionShape
    ...
    void reportIntersection( EventPoint2D eventPoint, List<EventPoint2D> lefts,
        ...
        // TODO: 6/16/2021 check for only cycles in this intersection,
        //  yes, no intersection at all,
        //  i.e. at least one line to report an intersection
...
//            statusRBTree.put( status );
    ...
    void detectNewEvent( EventPoint2D predecessor, EventPoint2D successor,
        ...
        leftsAndInteriors.sort( Vector::sortByY );
    ...
    void handleEventPoint( EventPoint2D eventPoint,
        ...
        // find sl and sr
        EventPoint2D predecessor = statusRBTree.lowerVal( eventPoint );
        EventPoint2D successor = statusRBTree.higherVal( eventPoint );
        ...
        // TODO: 6/16/2021 add IntersectionShape 
    ...
    void addEvents( EventRBTree eventQueue,
        ...
        // TODO: 6/15/2021 preprocess() lines and cycles
    ...
    // TODO: 6/16/2021 Line -> IntersectionShape 
    public static
    List<EventPoint2D> findIntersection( List<IntersectionShape> shapes ) {
        ...
        EventRBTree eventQueue = new EventRBTree( Vector::sortByX );
        ...
        StatusRBTree statusRBTree = new StatusRBTree( Vector::sortByY );
    ...
    TreeSet<Vector> bruteForceLinesIntersection( List<Line> lines ) {
        TreeSet<Vector> intersections = new TreeSet<>( Vector::sortByX );
    ...
    // TODO: 6/16/2021  bruteForceLineCycleIntersection
    public static
...
//        System.out.println( lineArcIntersect( lines[ 3 ], arcs[ 0 ] ) );
    ...
    void testOthers() {
        int index = 0;
        PriorityQueue<EventPoint2D> events = new PriorityQueue<>( Vector::sortByX );
